...
class Workout {
  date = new Date();
  id = (Date.now() + '').slice(-10); // creating a unique ID using the last 10 numbers of a date
...
// Test of classes
// const run1 = new Running([39, -12], 5, 10, 178);
// const cycling1 = new Cycling([39, -12], 25, 60, 523);
