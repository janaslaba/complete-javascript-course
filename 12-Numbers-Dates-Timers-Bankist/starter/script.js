...
const calcFormatDates = function (date, locale) {
...
const displayMovements = function (acc, sort = false) {
  ...
  movs.forEach(function (mov, i) {
    ...
    const displayDate = calcFormatDates(date, acc.locale);
...
// LECTURES
// Remainder operator
// Painting every second row in orange and every third row in blue
...
// Timers - setTimeout ()
// const ingredients = ['salami', 'vegetables'];
...
// setInterval(function () {
//   const now = new Intl.DateTimeFormat('pt-PT').format(new Date());
//   console.log(now);
// }, 5000);
